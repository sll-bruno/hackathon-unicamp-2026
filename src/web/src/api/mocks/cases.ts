...
const rows: Row[] = [
  ...
  ['0789012-88.2024.8.26.0100', 'José Roberto Almeida', 'SP', 'GOLPE', 14200, 'ENCERRADO', 120, 12, acordo(79, [3900, 4700], 5100, 5800), true, 'FAVORAVEL', 4650, MY_OFFICE],
  ...
  ['0812345-21.2024.8.26.0100', 'Marcos Vinícius Teixeira', 'SP', 'GOLPE', 24000, 'ENCERRADO', 200, 175, acordo(81, [6200, 7500], 8100, 9200), true, 'FAVORAVEL', 6900, 'Barros & Nunes Advogados'],
  ['0823456-32.2024.8.13.0024', 'Patrícia Helena Nogueira', 'MG', 'GOLPE', 17500, 'ENCERRADO', 190, 160, acordo(73, [4800, 5700], 6200, 7100), true, 'FAVORAVEL', 5300, 'Barros & Nunes Advogados'],
  ['0834567-43.2024.8.10.0001', 'Eduardo Luiz Machado', 'MA', 'GENERICO', 9800, 'ENCERRADO', 180, 150, defesa(69, 3400), true, 'DESFAVORAVEL', 9800, 'Campos Torres Advocacia'],
  ['0845678-54.2024.8.04.0001', 'Vanessa Cristina Farias', 'AM', 'GOLPE', 28500, 'ENCERRADO', 170, 130, acordo(85, [7900, 9300], 10100, 11800), true, 'FAVORAVEL', 8600, 'Barros & Nunes Advogados'],
  ...
  ['0867890-76.2024.8.17.0001', 'Camila dos Santos Vieira', 'PE', 'GOLPE', 21000, 'ENCERRADO', 150, 95, acordo(66, [5600, 6800], 7400, 8600), false, 'DESFAVORAVEL', 21000, 'Campos Torres Advocacia'],
  ['0878901-87.2024.8.26.0100', 'Fábio Henrique Cardoso', 'SP', 'GOLPE', 16800, 'ENCERRADO', 140, 80, acordo(88, [4500, 5400], 5900, 6700), true, 'FAVORAVEL', 5050, MY_OFFICE],
  ['0889012-98.2024.8.05.0001', 'Juliana Aparecida Moreira', 'BA', 'GENERICO', 10500, 'ENCERRADO', 130, 60, defesa(72, 3800), true, 'DESFAVORAVEL', 10500, 'Campos Torres Advocacia'],
  ['0890123-09.2024.8.13.0024', 'Bruno César Andrade', 'MG', 'GOLPE', 32000, 'ENCERRADO', 120, 45, acordo(79, [8600, 10200], 11000, 12800), true, 'FAVORAVEL', 9700, 'Ferreira Mendes & Cia'],
  ...
  ['0912345-21.2024.8.04.0001', 'Thiago Ribeiro Cavalcante', 'AM', 'GENERICO', 8700, 'ENCERRADO', 100, 20, defesa(84, 2900), true, 'FAVORAVEL', 2650, 'Ferreira Mendes & Cia'],
  ['0923456-32.2024.8.19.0001', 'Renata Souza Pimentel', 'RJ', 'GOLPE', 26500, 'ENCERRADO', 95, 15, acordo(60, [7100, 8500], 9300, 10600), false, 'DESFAVORAVEL', 26500, 'Campos Torres Advocacia'],
];
