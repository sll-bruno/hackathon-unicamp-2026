...
const OUTCOME_COLOR: Record<string, string> = {
  FAVORAVEL: 'var(--status-positive)',
  PARCIAL: 'var(--status-warning)',
  DESFAVORAVEL: 'var(--status-negative)',
};
...
export default function EffectivenessDashboard() {
  ...
  const successCount = outcomes.find((o) => o.outcome === 'FAVORAVEL')?.count ?? 0;
    ...
    <div className={styles.page}>
      ...
      <div className={styles.stats}>
        <StatCard
          ...
          tone="negative"
          hint={`${outcomes.find((o) => o.outcome === 'DESFAVORAVEL')?.count ?? 0} de ${closedTotal} casos encerrados`}
        />
